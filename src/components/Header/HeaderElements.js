...
export const HeaderContainer = Styled.header`
    ...
    height:${(props) =>
      props["data-scrolled"]
        ...
        : `${HEIGHT.navHeight}`};
    background:${(props) =>
      props.bgColor ? "rgb(25,25,25)" : `${COLORS.black}`};
    display:flex;
...
export const HeaderWrapper = Styled.div`
    ...
    align-items:center;
    position:relative;
    ${(props) => (props.borderBot ? headerBorderBottom : null)};
`;
...
export const MobNavWrapper = Styled.div`
    ...
    transform:${(props) =>
      props["data-open"] ? "translateX(0%)" : "translateX(-120%)"};
    transition:all ${TRANSITION.ease} transform;
    overflow-y:auto;
`;
...
export const MobNav = Styled.div`
    ...
    background:${COLORS.white};
    transform:${(props) =>
      props["data-open"] ? "translateY(0%)" : "translateY(-120%)"};
    transition:all ${TRANSITION.ease};
    transition-delay:.2s;
    height:fit-content;
    justify-content:center;
