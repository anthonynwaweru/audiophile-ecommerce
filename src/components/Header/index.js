      ...
      <HeaderWrapper borderBot={true}>
        ...
        <HeaderNav>
          ...
          <HeaderNavLink
            ...
            exact={true}
            data-active={
              !isHomePage && location.pathname === "/headphones" ? "active" : ""
            }
            aria-current="page"
          >
            headphones
          ...
          <HeaderNavLink
            ...
            exact={true}
            data-active={
              !isHomePage && location.pathname === "/speakers" ? "active" : ""
            }
            aria-current="page"
          >
            speakers
          ...
          <HeaderNavLink
            ...
            exact={true}
            data-active={
              !isHomePage && location.pathname === "/earphones" ? "active" : ""
            }
            aria-current="page"
          >
            earphones
